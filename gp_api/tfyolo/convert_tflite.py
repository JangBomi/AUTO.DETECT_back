...
flags.DEFINE_string('weights', 'gp_api/tfyolo/checkpoints/yolov4-416', 'path to weights file')
flags.DEFINE_string('output', 'gp_api/tfyolo/checkpoints/yolov4-416-fp32.tflite', 'path to output')
